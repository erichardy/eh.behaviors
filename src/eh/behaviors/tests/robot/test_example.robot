...
#
#  $ bin/test -s eh.behaviors -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src eh.behaviors.testing.EH_BEHAVIORS_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/eh/behaviors/tests/robot/test_example.robot
#
